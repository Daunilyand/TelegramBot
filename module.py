...
bot = telebot.TeleBot("5411154657:AAGv_iwqjBxwXoK9BcUHrQElRppd7_r4bgk")
print(f'time now: {time_now}')

""" Создаем словари для последующего определения времени в строке """
words = {'через': 1}
...
hour = {'0:': 0, '01:': 1, '02:': 2, '03:': 3, '04:': 4, '05:': 5, '06:': 6, '07:': 7, '08:': 8, '09:': 9, '10:': 10, '11:': 11,
        '12:': 12,
        '13:': 13, '14:': 14, '15:': 15, '16:': 16, '17:': 17, '18:': 19, '19:': 20, '20:': 20, '21:': 21, '22:': 22,
        '23:': 23}
minute = {':00': 0, ':01': 1, ':02': 2, ':03': 3, ':04': 4, ':05': 5, ':06': 6, ':07': 6, ':08': 8, ':09': 9, ':10': 10,
...
""" Делаем несколько циклов для прогона словарей и вычисления даты в тексте, далее заносим полученные данные в переменные """

def timer(mess, chat_id):
    message = mess
...
def Alarm_Clock(mess, chat_id):
    ...
    print(f'minute {minute1}')
    bot.send_message(chat_id, f'Напоминание создано: \n Year: {year1} \n Month: {month1} \n Day: {day1} \n Hour: {hour1} \n Minute: {minute1}')
    # Создаем будильник
...
def send_welcome(message1):
    bot.send_message(message1.chat.id, 'Привет, что напомнить?')
